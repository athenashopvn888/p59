...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse edible listings at PLANETS 59 in Brampton. Compare product names, package details, posted notes, and current menu information before choosing.",
    ...
    faqs: [
      { q: "What cannabis edibles do you carry?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoIntro: "Compare vape listings at PLANETS 59 in Brampton by product name, format, posted notes, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "Use the disposable vape category at PLANETS 59 for current product names, formats, and menu notes.",
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Compare concentrates at PLANETS 59 in Brampton by product type, name, posted notes, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoIntro: "Shop pre-rolls at PLANETS 59 by comparing current product name, format, package details, and posted notes.",
  ...
  "ADD ONS": {
    ...
    seoIntro: "Browse accessories at PLANETS 59 and compare current menu notes before visiting.",
