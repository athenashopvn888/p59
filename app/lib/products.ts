...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at PLANETS 59 on Brampton St, Brampton. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Brampton? PLANETS 59 stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 8500 Torbram Rd #59 — we are Open Daily: 10:00 AM - 01:00 AM.",
    faqs: [
  ...
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at PLANETS 59, Brampton. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "PLANETS 59 carries a curated selection of vape pens and cartridges in Brampton. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 8500 Torbram Rd #59 for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at PLANETS 59, Brampton. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. PLANETS 59 stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 8500 Torbram Rd #59, Brampton.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at PLANETS 59, Brampton. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "PLANETS 59 offers a premium selection of cannabis concentrates in Brampton. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 8500 Torbram Rd #59.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at PLANETS 59, Brampton. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from PLANETS 59 in Brampton. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 8500 Torbram Rd #59 — we are Open Daily: 10:00 AM - 01:00 AM.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at PLANETS 59, Brampton. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "PLANETS 59 carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 8500 Torbram Rd #59, Brampton.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Brampton — Discount Tobacco at PLANETS 59",
    seoIntro: "Discount native cigarettes at PLANETS 59, Brampton. Premium and value brands at the best prices on Brampton St.",
    seoDescription: "PLANETS 59 is your go-to source for affordable native cigarettes in Brampton. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 8500 Torbram Rd #59 in the heart of Torbram Rd & Steeles Ave E, we're Open Daily: 10:00 AM - 01:00 AM.",
    faqs: [
      { q: "Do you sell cigarettes at PLANETS 59?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the Torbram Rd & Steeles Ave E area of Brampton." },
    ],
  },
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at PLANETS 59, Brampton.",
    seoDescription: "PLANETS 59 carries a curated selection of magic mushrooms and specialty products in Brampton. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 8500 Torbram Rd #59 for our full selection.",
    faqs: [
