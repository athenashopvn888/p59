...
export function WeedOwnerPage() {
  ...
  return <main className={styles.page}>
    ...
    <header className={styles.hero}>
      ...
      <div className={styles.actions}><Link href="/visit" className={styles.primary}>Unit 59 visit guide</Link><Link href="/weed-delivery-brampton" className={styles.secondary}>View Brampton Delivery</Link></div>
    </header>
