...
export function WeedOwnerPage() {
  ...
  return <main className={styles.page}>
    ...
    <header className={styles.hero}>
      ...
      <div className={styles.actions}><Link href="/visit" className={styles.primary}>Unit 59 visit guide</Link><Link href="/24-hour-dispensary-torbram" className={styles.secondary}>24-hour Torbram FAQ</Link><Link href="/weed-delivery-torbram" className={styles.secondary}>Torbram weed delivery</Link></div>
    </header>
