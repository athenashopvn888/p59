...
const faqs = [
  ["Where is PLANETS 59 located?", "PLANETS 59 is located at 8500 Torbram Rd #59, Brampton, ON L6T 5C6, near Steeles Avenue East."],
  ["Is PLANETS 59 open 24 hours?", "Yes. The PLANETS 59 storefront is open 24 hours daily."],
  ...
  ["Is this location in Mississauga?", "No. PLANETS 59 is located in Brampton. Customers coming from Mississauga can use the visitor guide and current map or transit information to plan the trip."],
...
export function WeedOwnerPage() {
  const schema = [
    { "@context": "https://schema.org", "@type": "WebPage", "@id": "https://www.planets59.com/weed-dispensary-brampton/#webpage", url: "https://www.planets59.com/weed-dispensary-brampton", name: "24-Hour Cannabis Dispensary in Brampton | PLANETS 59", description: "Visit PLANETS 59 at 8500 Torbram Rd #59 in Brampton, near Steeles Ave E. Store open 24 hours daily. Brampton delivery runs 10 a.m.–10 p.m.", about: { "@id": "https://www.planets59.com/#store" }, mainEntity: { "@id": "https://www.planets59.com/#store" } },
  ...
  return <main className={styles.page}>
    ...
    <header className={styles.hero}>
      <p className={styles.eyebrow}>PLANETS 59 · Torbram Road &amp; Steeles Avenue East</p>
      <h1>24-Hour Cannabis Dispensary in Brampton</h1>
      <p>PLANETS 59 is a Brampton cannabis store at 8500 Torbram Rd #59, Brampton, ON L6T 5C6, near Steeles Avenue East. The storefront is open 24 hours daily. Whether you already know which part of the menu you want to explore or simply need the store location before heading out, this page brings the essential Brampton visit information together in one place.</p>
      <div className={styles.actions}><Link href="/contact" className={styles.primary}>Get Brampton Store Details</Link><Link href="/weed-delivery-brampton" className={styles.secondary}>View Brampton Delivery</Link></div>
    </header>
    <section className={styles.section}><h2>Visit PLANETS 59 on Torbram Road</h2><address className={styles.address}><strong>PLANETS 59</strong><br />8500 Torbram Rd #59<br />Brampton, ON L6T 5C6<br /><a href="tel:+12895367493">+1 289-536-7493</a><br />Open 24 Hours Daily</address><p>Use your current map or transit service for up-to-date travel information before leaving.</p></section>
    <section className={styles.section}><h2>Browse the Five Weed Collections</h2><div className={styles.cards}>{flowerCollections.map(([title, href]) => <Link href={href} className={styles.card} key={href}><h3>{title}</h3><p>Explore the PLANETS 59 {title} collection.</p><span>Explore →</span></Link>)}</div><p>Each collection has its own page. Use the current collection and product pages for the information shown at the time you browse. You can also explore the existing PLANETS 59 categories for pre-rolls, edibles, THC vapes, concentrates and other menu sections without mixing those formats into the flower collections.</p></section>
