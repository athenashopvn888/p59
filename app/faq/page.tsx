...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about PLANETS 59 in Brampton. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      ...
      { q: "What's the best way to get to PLANETS 59?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
