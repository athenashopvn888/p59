  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=PL501`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          PLANETS 59 is launching delivery across Brampton.
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}>🌉</span>
            <h3 className={styles.infoTitle}>Serving Brampton</h3>
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>8500 Torbram Rd #59, Brampton</strong> —
            we are <strong>Open Daily: 10:00 AM - 01:00 AM</strong>. Call <strong>(416) 300-7806</strong>.
          </p>
        </div>
      </div>
      <Footer />
