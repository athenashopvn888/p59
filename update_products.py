"""
PLANETS 59 — Product Update Script
===================================
Drop your ONHAND CSV into the p59 folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  PLANETS 59 — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://planets59.com")
    else:
