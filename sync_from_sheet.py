"""
PLANETS 59 - Auto Sync from Google Sheets
==========================================
...
a filtered menu for PLANETS 59 (ALC01).
...
def main():
    print("=" * 60)
    print(f"  PLANETS 59 - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://planets59.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
