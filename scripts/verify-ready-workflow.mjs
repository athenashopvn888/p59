...
const source = readFileSync(new URL("../app/delivery/P59WebChat.tsx", import.meta.url), "utf8");
...
assert.match(source, /storeId: "P59"/);
...
console.log("READY workflow storefront guard passed for P59.");
